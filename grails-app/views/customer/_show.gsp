...
<div class="column-hold" name="show-customer-notes">
	<!-- user notes -->
    ...
    <div class="box">
        <div class="sub-box" name="show-customer-details">
            <table class="dataTable" cellspacing="0" cellpadding="0" name="customer-details">
                    <tbody>
                        <tr>
    ...
    <div class="box">
        ...
        <div class="sub-box" name="show-customer-recent"><!-- show most recent order, invoice and payment -->
...
<!-- Assets start  -->
 ...
 <br/>
<!-- Assets end -->
    <div class="btn-box" name="show-customer-assets">
        <g:if test="${!selected.deleted}">
            <div class="row">
