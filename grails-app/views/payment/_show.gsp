...
<div class="column-hold">
    ...
    <div class="box">
      <div class="sub-box">
        <!-- user details -->
        <table class="dataTable" cellspacing="0" cellpadding="0"  name="show-payment-user-details">
            <tbody>
        ...
        <!-- payment details -->
        <table class="dataTable" cellspacing="0" cellpadding="0"  name="show-payment-details">
            <tbody>
                <tr>
        ...
        <table class="dataTable" cellspacing="0" cellpadding="0"  name="show-payment-metaFileds">
            <tbody>
                <tr>
        ...
        <g:if test="${selected.invoicesMap}">
            ...
            <table cellpadding="0" cellspacing="0" class="innerTable"  name="show-linked-invoices">
    ...
    <g:if test="${selected.paymentAuthorizations}">
        ...
        <div class="box">
            <div class="sub-box" name="show-authorization-details">
    ...
    <g:if test="${selected?.paymentInstrumentsInfo.size()>0}">
        ...
        <div class="box" name="show-credit-card-details">
