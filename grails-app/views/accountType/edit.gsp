        ...
        <fieldset>
            ...
            <div class="box">
                <div class="form-columns">
                    ...
                    <g:applyLayout name="form/select">
                        <content tag="label"><g:message code="prompt.user.currency"/><span id="mandatory-meta-field">*</span></content>
                    ...
                    <g:applyLayout name="form/select">
                        <content tag="label"><g:message code="prompt.user.language"/><span id="mandatory-meta-field">*</span></content>
