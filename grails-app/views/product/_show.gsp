...
<div class="column-hold">
	...
	<div class="box">
        <div class="sub-box">
            <!-- product info -->
            <table class="dataTable" cellspacing="0" cellpadding="0"  name="show-item-details">
                <tbody>
                    <tr>
            ...
            <!-- flags & meta fields -->
            <table class="dataTable" cellspacing="0" cellpadding="0"  name="show-item-metaFileds">
                <tbody>
                    <tr>
            ...
            <div class="box-cards box-cards-open">
                ...
                <div class="box-card-hold"  name="show-categories-detail">
                    <div class="content">
                        <ul class="cloud">
            ...
            <div class="box-cards box-cards-open">
                ...
                <div class="box-card-hold" name="show-item-orderLine-metaFields">
                    <div class="content">
            ...
            <div class="box-cards box-cards-open">
                ...
                <div class="box-card-hold" name="show-item-dependency-details">
                    <div class="content">
