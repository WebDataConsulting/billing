...
<div class="column-hold">
    ...
    <!-- Order Details -->
    <div class="box">
        <div class="sub-box" name="show-order-details">
    ...
    <!-- Order Notes -->
    <div class="box">
        <div class="sub-box" name="show-order-notes">
    ...
    <!-- Order Lines -->
    <div class="box">
        <div class="sub-box" name="show-order-line">
    ...
    <g:if test="${order?.hasLinkedAssets()}">
        ...
        <div class="box-card-hold" name="show-order-assets">
    ...
    <g:if test="${order?.generatedInvoices}">
        ...
        <div class="box">
            <div class="sub-box" name="show-generated-invoices">
                <table class="innerTable" >
                    <thead class="innerHeader">
                         <tr>
