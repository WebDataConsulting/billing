...
<div class="column-hold">
    ...
    <!-- Invoice details -->
    <div class="box">
        <div class="sub-box" name="show-invoice-user-details">
    ...
    <g:if test="${selected.invoices}">
        ...
        <div class="box">
            ...
            <div class="sub-box" name="show-invoice-details">
    ...
    <div class="box">
        <div class="sub-box" name="show-invoice-lines">
    ...
    <div class="box">
        <div class="sub-box" name="show-linked-payments">
