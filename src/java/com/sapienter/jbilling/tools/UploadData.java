...
*/
            ...
            while (record != null) {
                ...
                user.addRole(new RoleDTO(CommonConstants.TYPE_CUSTOMER));
                if (first_name >= 0) {
                ...
                if (credit_card_number >= 0 &&
                    ...
                    piBl.updateStringMetaField(instrument, DateTimeFormat.forPattern(ServerConstants.CC_DATE_FORMAT).print(date.getTime()), MetaFieldType.DATE);
                    if (name_on_card >= 0) {
                ...
                Set<MetaFieldValue> metaFields = new TreeSet<>();
 ...
 */                   // add the item (quantity = 1)
                    ...
                    OrderDTO thisOrder = remoteOrder.addItem(itemId, CommonConstants.BIGDECIMAL_ONE, summary, languageId,
                                                             newUserId, entityId);
