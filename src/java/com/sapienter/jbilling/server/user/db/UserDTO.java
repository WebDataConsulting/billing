...
public class UserDTO implements Serializable, Exportable {
    ...
    public void removePayment(PaymentDTO payment){this.payments.remove(payment);}
    ...
    public void addPurchaseOrdersForCreatedBy(OrderDTO purchaseOrdersForCreatedBy){this.purchaseOrdersForCreatedBy.add(purchaseOrdersForCreatedBy);}

    public void removePurchaseOrdersForCreatedBy(OrderDTO purchaseOrdersForCreatedBy){this.purchaseOrdersForCreatedBy.remove(purchaseOrdersForCreatedBy);}
    ...
    public void removeOrder(OrderDTO order){this.orders.remove(order);}
    ...
    public void addNotificationMessageArch(NotificationMessageArchDTO notificationMessageArch){this.notificationMessageArchs.add(notificationMessageArch);}

    public void removeNotificationMessageArch(NotificationMessageArchDTO notificationMessageArch){this.notificationMessageArchs.remove(notificationMessageArch);}
    ...
    public void addInvoice(InvoiceDTO invoice){this.invoices.add(invoice);}

    public void removeInvoice(InvoiceDTO invoice){this.invoices.remove(invoice);}
    ...
    public void addProcess(BillingProcessFailedUserDTO process){this.processes.add(process);}

    public void removeProcess(BillingProcessFailedUserDTO process){this.processes.remove(process);}
    ...
    public void addPaymentInstrument(PaymentInformationDTO paymentInstrument){this.paymentInstruments.add(paymentInstrument);}

    public void removePaymentInstrument(PaymentInformationDTO paymentInstrument){this.paymentInstruments.remove(paymentInstrument);}
        ...
        Object[][]values= new Object[][]{
                {
                        ...
                        (customer != null && !customer.getCustomerNotes().isEmpty()
                                ? customer.getCustomerNotes().iterator().next().getNoteContent()
                                : null),
