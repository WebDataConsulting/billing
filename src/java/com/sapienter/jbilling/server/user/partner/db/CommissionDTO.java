...
public class CommissionDTO implements Serializable, Exportable {
    ...
    public void addInvoiceCommission (InvoiceCommissionDTO invoiceCommission) { this.invoiceCommissions.add(invoiceCommission);}

    public void removeInvoiceCommission (InvoiceCommissionDTO invoiceCommission) { this.invoiceCommissions.remove(invoiceCommission);}
