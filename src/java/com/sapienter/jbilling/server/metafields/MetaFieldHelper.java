...
public class MetaFieldHelper {
    ...
    public static void removeEmptyMetaFields(MetaContent entity) {
        Set<MetaFieldValue> metaFields = entity.getMetaFields();
     ...
     */
    public final static class MetaFieldValuesOrderComparator implements Comparator<MetaFieldValue>, Serializable {
