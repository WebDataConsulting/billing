...
public abstract class MetaFieldValue<T> implements Serializable, Comparable {
    ...
    public int compareTo(Object o) {
        MetaFieldValue o1 = null;
        if (o instanceof MetaFieldValue ) {
            o1 = (MetaFieldValue) o;
        } else {
            return -1;
        }
        if ( null != this.getField() && null != this.getField().getDisplayOrder() ) {
            if ( null != o1 && null != o1.getField() ) {
                return this.getField().getDisplayOrder().compareTo(o1.getField().getDisplayOrder());
            }
        }
        return 0;
    }
