...
public class BillingProcessDTO implements Serializable {
    ...
    */
    ...
    public void addOrderProcess (OrderProcessDTO orderProcess){
        this.orderProcesses.add(orderProcess);
    }

    public void removeOrderProcess (OrderProcessDTO orderProcess){
        this.orderProcesses.remove(orderProcess);
    }
    ...
    public void addProcessRun (ProcessRunDTO processRun){
        this.processRuns.add(processRun);
    }

    public void removeProcessRun (ProcessRunDTO processRun){
        this.processRuns.remove(processRun);
    }
    ...
    public void addBatchProcess ( BatchProcessInfoDTO batchInfo){
        this.batchInfos.add(batchInfo);
    }

    public void removeBatchProcess ( BatchProcessInfoDTO batchInfo){
        this.batchInfos.remove(batchInfo);
    }
