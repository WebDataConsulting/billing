...
public class PaymentDTO extends CustomizedEntity implements Serializable, Exportable {
    ...
    public PaymentDTO(PaymentDTO dto) {
        ...
        this.setMetaFields(new TreeSet<MetaFieldValue>(dto.getMetaFields()));
    }
    ...
    public void addPaymentAuthorization ( PaymentAuthorizationDTO paymentAuthorization ){this.paymentAuthorizations.add(paymentAuthorization);}

    public void removePaymentAuthorization ( PaymentAuthorizationDTO paymentAuthorization ){this.paymentAuthorizations.remove(paymentAuthorization);}
    ...
    public void addInvoicesMap(PaymentInvoiceMapDTO invoicesMap){this.invoicesMap.add(invoicesMap);}

    public void removeInvoicesMap(PaymentInvoiceMapDTO invoicesMap){this.invoicesMap.remove(invoicesMap);}
    ...
    public void addPaymentInstrumentsInfo(PaymentInstrumentInfoDTO paymentInstrumentsInfo ){this.paymentInstrumentsInfo.add(paymentInstrumentsInfo);}

    public void removePaymentInstrumentsInfo(PaymentInstrumentInfoDTO paymentInstrumentsInfo ){this.paymentInstrumentsInfo.remove(paymentInstrumentsInfo);}
