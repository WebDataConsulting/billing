...
public class PluggableTaskDTO implements java.io.Serializable {
    ...
    public void addParameter(PluggableTaskParameterDTO parameter){this.parameters.add(parameter);}

    public void removeParameter(PluggableTaskParameterDTO parameter){this.parameters.remove(parameter);}
