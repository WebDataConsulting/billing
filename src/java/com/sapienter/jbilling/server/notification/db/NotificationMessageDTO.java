...
public class NotificationMessageDTO implements Serializable {
    ...
    public void addNotificationMessageSection (NotificationMessageSectionDTO notificationMessageSection){this.notificationMessageSections.add(notificationMessageSection);}

    public void removeNotificationMessageSection (NotificationMessageSectionDTO notificationMessageSection){this.notificationMessageSections.remove(notificationMessageSection);}
