...
public class MediationConfigurationBL {
    ...
    public static MediationConfigurationWS getWS(MediationConfiguration dto) {
        return dto != null ? MediationConfigurationBL.getDTO(dto) : null;
    }
    ...
    public static MediationConfigurationWS getDTO(MediationConfiguration dto) {
        MediationConfigurationWS retvalue = new MediationConfigurationWS();
        retvalue.setId(dto.getId());
        retvalue.setEntityId(dto.getEntityId());
        retvalue.setPluggableTaskId(dto.getPluggableTask().getId());
        retvalue.setName(dto.getName());
        retvalue.setOrderValue(dto.getOrderValue());
        retvalue.setCreateDatetime(dto.getCreateDatetime());
        retvalue.setVersionNum(dto.getVersionNum());
        return retvalue;
    }
}
