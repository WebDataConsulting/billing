...
public class OrderLineDTO extends CustomizedEntity implements Serializable, Comparable {
    ...
    public void addAssetAssignment (AssetAssignmentDTO assetAssignment ){this.assetAssignments.add(assetAssignment);}

    public void removeAssetAssignment (AssetAssignmentDTO assetAssignment ){this.assetAssignments.remove(assetAssignment);}
    ...
    public void addChildLine (OrderLineDTO childLine){this.childLines.add(childLine);}

    public void removeChildLine (OrderLineDTO childLine){this.childLines.remove(childLine);}
    ...
    public void moveToOtherOrder (OrderDTO otherOrder) {
        this.getPurchaseOrder().removeLine(this);
        this.setPurchaseOrder(otherOrder);
        this.getPurchaseOrder().addLine(this);
