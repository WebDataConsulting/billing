...
public class OrderChangeTypeDTO implements Serializable {
    ...
    public void addOrderChangeTypeMetaField (MetaField orderChangeTypeMetaField){this.orderChangeTypeMetaFields.add(orderChangeTypeMetaField);}

    public void removeOrderChangeTypeMetaField (MetaField orderChangeTypeMetaField){this.orderChangeTypeMetaFields.remove(orderChangeTypeMetaField);}
