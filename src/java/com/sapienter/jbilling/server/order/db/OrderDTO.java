...
public class OrderDTO extends CustomizedEntity implements Serializable, Exportable, UserCodeAssociate<UserCodeOrderLinkDTO> {
    ...
    public void init(OrderDTO other) {
        ...
        for (OrderDTO childOrder : other.getChildOrders()) {
            addChildOrder(new OrderDTO(childOrder));
        }
    ...
    public void addOrderProcess (OrderProcessDTO orderProcess){this.orderProcesses.add(orderProcess);}

    public void removeOrderProcess (OrderProcessDTO orderProcess){this.orderProcesses.remove(orderProcess);}
    ...
    public void addLine (OrderLineDTO line ){this.lines.add(line);}

    public void removeLine (OrderLineDTO line ){this.lines.remove(line);}
    ...
    public void addDiscountLine (DiscountLineDTO discountLine ){this.discountLines.add(discountLine);}

    public void removeDiscountLine (DiscountLineDTO discountLine ){this.discountLines.remove(discountLine);}
    ...
    public void addChildOrder (OrderDTO childOrder ){this.childOrders.add(childOrder);}

    public void removeChildOrder (OrderDTO childOrder){this.childOrders.remove(childOrder);}
    ...
    */
    ...
    public void removeUserCodeLink(UserCodeOrderLinkDTO userCodeLink){this.userCodeLinks.remove(userCodeLink);}
