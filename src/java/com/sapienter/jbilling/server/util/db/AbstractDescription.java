...
public abstract class AbstractDescription implements Serializable {
    ...
    public String getDescription() {
        if (description == null) {
        	description = getDescription(LANGUAGE_ENGLISH_ID);
        }
        return description;
    ...
    public String getDescription(Integer languageId) {
        ...
        return description != null ? description.getContent() : ( !LANGUAGE_ENGLISH_ID.equals(languageId) ? getDescription(LANGUAGE_ENGLISH_ID) : null) ;
    }
    ...
    public String getDescription(Integer languageId, String label) {
		...
		if (description == null
				&& !LANGUAGE_ENGLISH_ID.equals(languageId)) {
        	//get string for the given label and default language
        	description = getDescriptionDTO(LANGUAGE_ENGLISH_ID, label);
        }
